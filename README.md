...
function RadientPaid:Window(text,maincolor)
   ...
   UserImage.Size = UDim2.new(0, 34, 0, 34)
   UserImage.Image = "http://www.roblox.com/asset/?id=9594794165"

   UserCircleImage.Name = "UserImage"
   UserCircleImage.Parent = UserImage
   UserCircleImage.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
   UserCircleImage.BackgroundTransparency = 1.000
   UserCircleImage.Size = UDim2.new(0, 34, 0, 34)
   ...
   UserTag.TextColor3 = Color3.fromRGB(102, 0, 255)
   UserTag.TextSize = 17.000
   UserTag.TextTransparency = 0
   UserTag.TextXAlignment = Enum.TextXAlignment.Left

   UserName.Text = "GISPER HUB"
   UserTag.Text = "  Script User"
   ...
   function RadientPaid:Notification(titletext, desctext, btntext)
      ...
      AlrightBtn.MouseEnter:Connect(function()
         TweenService:Create(
            AlrightBtn,
            TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
            {BackgroundColor3 = Color3.fromRGB(102, 0, 255)}
         ):Play()
      end)
   ...
   function ServerHold:Server(text,textgame, img)
      ...
      Server.TextColor3 = Color3.fromRGB(102, 0, 255)
      ...
      ServerTitle.TextColor3 = Color3.fromRGB(102, 0, 255)
      ...
      function ChannelHold:Channel(text)
         ...
         function ChannelContent:Toggle(text,default,callback)
            ...
            Toggle.MouseButton1Click:Connect(function()
               if toggled == false then
                  ...
                  TweenService:Create(ToggleFrame,TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{BackgroundColor3 = Color3.fromRGB(102, 0, 255)}):Play()
         ...
         function ChannelContent:Slider(text, min, max, start, callback)
            ...
            SliderTitle.BackgroundColor3 = Color3.fromRGB(102, 0, 255)
            ...
            CurrentValueFrame.BackgroundColor3 = Color3.fromRGB(102, 0, 255)
         ...
         function ChannelContent:Dropdown(text, list, callback)
            ...
            DropItemHolder.ScrollBarImageColor3 = Color3.fromRGB(102, 0, 255)
         ...
         function ChannelContent:Label(text)
            ...
            LabelTitle.TextColor3 = Color3.fromRGB(102, 0, 255)
   ...
   return ServerHold
	...
	local serv = win:Server("Tud", "Blox Fruit")
	local Genaral = serv:Channel("Genaral")
    Genaral:Label("Select Weapon")
Weapon = {}
for i,v in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
    ...
    local SL = Genaral:Dropdown("Select Weapon",Weapon, function(v)
        _G.SelectWeapon = v
    end)
    Genaral:Button("Refresh Weapon", function()
        RadientPaid:Notification("Weapon Refresh Sucsessfully!", "Refresh Weapon", "OKEY")
SL:Clear()
for i,v in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
    if v:IsA ("Tool") then
        table.insert(Weapon,v.Name)
SL:Add(v.Name)
    ...
    Genaral:Label("_________________________________________________")
    Genaral:Label("Auto Farm Level 1 - 2300")
    Genaral:Toggle("Auto Farm", false, function(t)
        _G.AutoFarm = t
    end)
...
Genaral:Toggle("Fast Attack", false, function(t)
        _G.FastAttack
    end)
